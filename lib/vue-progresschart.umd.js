...
// CONCATENATED MODULE: ./packages/progresschart.vue?vue&type=template&id=1c357372&
...
/* harmony default export */ var progresschartvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    circle: function circle(cx, cy, r, process, img) {
      ...
      this.pointCircle(cx + Math.cos(Math.PI / 180 * this.rotate) * r, cx + Math.sin(Math.PI / 180 * this.rotate) * r, this.lineWidth / 2, ctx.strokeStyle); //  终点位置
    ...
    line: function line(cx, cy, process) {
      ...
      if (this.progressShow) {
        ...
        this.renderText(parse_float_default()(process).toFixed(0), fontLeft, cy * 2 - this.lineWidth * 2 - 2);
      }

      this.pointCircle(0 + this.lineWidth, cy * 2 - this.lineWidth, this.lineWidth / 2, ctx.strokeStyle); // 终点位置
