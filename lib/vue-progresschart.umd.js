...
// CONCATENATED MODULE: ./packages/progresschart.vue?vue&type=template&id=ccfe7f6c&
...
/* harmony default export */ var progresschartvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    line: function line(cx, cy, process) {
      ...
      if (this.progressShow) {
        var fontLeft = this.lineWidth + (cx * 2 - this.lineWidth * 2) * process / 100 - this.fontSize / 6 * len - this.fontSize / 2;
        var deviation = cx * 2 - this.fontSize - this.fontSize / 6 * len - this.fontSize / 2;
        fontLeft = this.critical(fontLeft, this.lineWidth / 2 + 1, deviation);
        this.renderText(parse_float_default()(process).toFixed(0), fontLeft, cy * 2 - this.lineWidth * 1.5 + (this.lineWidth - this.fontSize) / 4 - 2);
      }
