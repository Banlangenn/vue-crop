...
// CONCATENATED MODULE: ./packages/progresschart.vue?vue&type=template&id=064f6624&
  ...
  methods: {
    ...
    line: function line(cx, cy, process) {
      ...
      if (this.progressShow) {
        ...
        this.renderText(parse_float_default()(process).toFixed(0), fontLeft, cy * 2 - this.lineWidth * 1.5 + (this.lineWidth - this.fontSize) / 4);
      }
