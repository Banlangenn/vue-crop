...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=ff1d5020&
  ...
  methods: {
    ...
    getPointByCoordinate: function getPointByCoordinate(_ref5) {
      ...
      if (this.checkRegion(x, y, touchBar)) {
        ...
        return;
        ...
        else if (this.shape !== 'arc' && this.points.some(function (point, i) {
            index = i;
          ...
          else if (this.shape !== 'arc' && this.lines.some(function (line, i) {
              index = i;
