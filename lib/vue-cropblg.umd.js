...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=10a982bb&
...
/* harmony default export */ var cropblgvue_type_script_lang_js_ = ({
  name: 'crop',
  props: ['value', 'position', 'textWatermark', 'imgWatermark', 'defaultImgUrl', 'color'],
  data: function data() {
    return {
      // ready: false,
      noImage: true,
  ...
  methods: {
    ...
    getImage: function getImage() {
      ...
      return new promise_default.a(function (resolve, reject) {
        ...
        if (_this.imgWatermark) {
          var watermarkImg = new Image();
          watermarkImg.src = _this.getFileSrc(_this.imgWatermark);
