  ...
  methods: {
    ...
    handlePointMove({
      ...
      const cropper = this.cropper,
        ...
        cropperX,
        cropperY
      } = this.getNewCropper(x, y, cropper);
    ...
    getImage(type = 'Base64', mimeType = 'image/jpeg', quality = 1) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const [left = '50%', top = '50%', size = 1, angle = 0] = this.position; // angle = this.angle || 0
        ...
        if (this.textWatermark) {
          ...
          const text = this.textWatermark,
                ...
                textY = (h - height * 2.82) * parseInt(top) / 100; // 变量申请

          cCtx.fillStyle = this.color || this.averageColor; // console.log(this.cCtx.fillStyle)
