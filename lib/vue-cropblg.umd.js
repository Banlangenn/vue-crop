...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=569b3ff7&
    ...
    getPointByCoordinate: function getPointByCoordinate(_ref5) {
      ...
      if (this.checkRegion(x, y, touchBar)) {
        ...
        return;
          ...
          else if (shape !== 'arc' && this.lines.some(function (line, i) {
              index = i;
    ...
    getImage: function getImage() {
      ...
      return new promise_default.a(function (resolve, reject) {
        ...
        var _this2$position = _slicedToArray(_this2.position, 4),
            ...
            angle = _this2$position$4 === void 0 ? 0 : _this2$position$4;
        ...
        if (_this2.imageWatermark) {
          ...
          watermarkImg.onload = function () {
            ...
            types[type](_this2.canvas, mimeType, resolve);
          };
