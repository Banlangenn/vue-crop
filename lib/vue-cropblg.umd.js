...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=53190108&
    ...
    getImage: function getImage() {
      ...
      return new promise_default.a(function (resolve, reject) {
        ...
        if (_this2.textWatermark) {
          ...
          cCtx.fillStyle = _this2.color || _this2.averageColor; // console.log(this.cCtx.fillStyle)
