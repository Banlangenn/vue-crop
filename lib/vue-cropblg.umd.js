...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=071fcfd8&
...
/* harmony default export */ var cropblgvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getImage: function getImage() {
      ...
      this.cCtx.drawImage(image.element, (image.x - cropper.x) * quality, //  是负数
      (image.y - cropper.y) * quality, // 负数
      image.width * quality, image.height * quality);
      return new promise_default.a(function (resolve, reject) {
        ...
        var height = _this.limit(12 * size, 12, 30);

        _this.cCtx.font = height + 'px Georgia';

        var text = _this.$slots.watermark[0].text.trim() || '请直接放文字',
            width = _this.cCtx.measureText(text).width,
            x = (w - width) * parse_int_default()(left) / 100,
            y = (h + height / 2) * parse_int_default()(top) / 100; // 变量申请


        _this.cCtx.fillStyle = _this.averageColor; // console.log(this.cCtx.fillStyle)
