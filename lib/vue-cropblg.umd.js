...
// CONCATENATED MODULE: ./packages/cropblg.vue?vue&type=template&id=456c19d0&
...
/* harmony default export */ var cropblgvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    createImage: function createImage(imgfile, type) {
      var _this4 = this;
      ...
      img.onload = function () {
        ...
        getImageDirection(img).then(function (res) {
          ...
          correctImage(img, res).then(function (Img) {
            // alert('123')
            _this4.init(Img);
          });
        }).catch(function (err) {
